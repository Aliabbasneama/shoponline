					...
					<div class="container-fluid">
                        ...
                        <br><br>                                            
                         ...
                         @if(!empty($category->image))
                            <div>
                                <img width="" src="{{asset('uploads/category/thumb/'.
                                    $category->image)}}" alt="">
                            </div>
                            @endif
							</div>
                    ...
                    $("#categoryForm").submit(function(event){
					   ...
					   $("button[type=submit]").prop('disabled',true);
                        ...
                        window.location.href="{{route('categories.index')}}"
									...
									$("#name").remove('is-invalid').siblings('p')
									.remove('invalid-feedback').html("");

									$("#slug").remove('is-invalid').siblings('p')
									.remove('invalid-feedback').html("");

								}else{
									var errors = respons['errors']
								if (errors['name']) {
